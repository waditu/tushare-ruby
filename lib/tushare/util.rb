...
module Tushare
  ...
  INDEX_SYMBOL = {'399990' => 'sz399990', '000006' => 'sh000006', '399998' => 'sz399998',
                ...
                'hkHSI' => 'hkHSI' }.freeze
  KLINE_TT_URL = '%sweb.ifzq.%s/appstock/app/%skline/get?_var=kline_day%s&param=%s,%s,%s,%s,640,%s&r=0.%s'.freeze
  TT_K_TYPE = { 'D' => 'day', 'W' => 'week', 'M' => 'month' }.freeze
  KLINE_TT_MIN_URL = '%sifzq.%s/appstock/app/kline/mkline?param=%s,m%s,,640&_var=m%s_today&r=0.%s'.freeze
